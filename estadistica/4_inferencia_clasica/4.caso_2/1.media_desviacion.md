...
Tu estrategia lleva 30 operaciones. En cada una, registraste el resultado en porcentaje respecto al capital comprometido:
...
## Paso 1: calcular el promedio (media)

Una forma de resumir estos datos es con el **valor promedio**. Es decir, cuánto ganaste (o perdiste) por operación, en promedio:

En este caso:

$\bar{x} = \frac{29.8}{30} = 0.993 %$

Este resultado significa que **en promedio ganás cerca del 1% por operación**.

Pero el promedio no lo dice todo. Dos estrategias pueden tener la misma media, pero comportamientos muy distintos. Por eso necesitamos mirar también **la variabilidad** de los resultados.

***

## Paso 2: medir la variabilidad (desviación estándar)
...
La medida más usada para cuantificar la dispersión es la **desviación estándar**. Nos ayuda a responder:
...
Con los datos del ejemplo, se obtiene:

* Varianza:

* Desviación estándar: ( s = 2.07 %\ )

Eso indica que tus rendimientos fluctúan, en promedio, unos ±2 puntos porcentuales alrededor del promedio del 1%.
...
* Te permite comparar estrategias con igual media pero diferente riesgo.

* Es base para otras métricas como el **Sharpe Ratio**.

***

## Visualizando la variabilidad

Podemos graficar los 30 rendimientos individuales con:

* Una línea horizontal con la media (1%).

* Bandas sombreadas que indiquen ±1 desviación estándar.

Eso permite ver:

* Qué tan concentrados están los resultados.

* Cuántos están lejos (posibles outliers).

_(Ver gráfico generado con código)_
...
* La **desviación estándar** te dice qué tan dispersos están.

Juntas, estas dos medidas forman la base de muchas decisiones estadísticas… y también de muchas decisiones de trading.
